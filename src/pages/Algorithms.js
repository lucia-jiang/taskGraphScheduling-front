    ...
    return (<div className={"container"}>
        <div className={"row"}>
            <div className={"col-md-6"}>
                <AlgorithmExplanation algorithmTitle={"Algorithm 1"}
                                      algorithmName={"alg1"}
            ...
            <div className={"col-md-6"}>
                <AlgorithmExplanation algorithmTitle={"Algorithm 2"}
                                      algorithmName={"alg2"}
        ...
        <div className={"row mt-4 mb-4"}>
            <div className={"col-md-6"}>
                <AlgorithmExplanation algorithmTitle={"Algorithm 3"}
                                      algorithmName={"alg3"}
            ...
            <div className={"col-md-6"}>
                <AlgorithmExplanation algorithmTitle={"Algorithm 4"}
                                      algorithmName={"alg4"}
