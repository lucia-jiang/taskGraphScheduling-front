...
const TimeChallenge = ({}) => {
    ...
    return (<div className={"rounded-square"}>
        ...
        <p1>
            Game Time Challenge is a game where you aim to efficiently schedule tasks across multiple processors. It
            ...
            scheduling prowess and
            achieve the best time possible!
        </p1>
